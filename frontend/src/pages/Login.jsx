  ...
  return (
    <div className="app-bg flex flex-col items-center justify-center min-h-screen px-4">
      ...
      <div className="card-surface w-full max-w-md p-8 fade-up">
        ...
        <button data-testid="google-login-btn" onClick={loginGoogle} className="w-full flex items-center justify-center gap-2.5 py-2.5 rounded-lg border border-[#242f3d] text-sm font-medium hover:bg-[#141a24] transition-colors">
